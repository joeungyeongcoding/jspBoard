...
<jsp:useBean id="db" class="jspBoard.dao.DBConnect" scope="page"/>
 ...
 <%
  ...
  String userpass = (String) sess1.getAttribute("userpass");
  String username = (String) sess1.getAttribute("username");
  String useremail = (String) sess1.getAttribute("useremail");
  String usertel = (String) sess1.getAttribute("usertel");
  String addr1 = (String) sess1.getAttribute("addr1");
  String addr2 = (String) sess1.getAttribute("addr2");
  String userlink = (String) sess1.getAttribute("userlink");
    ...
    <section>
       ...
       <div class="listbox">
          ...
          <p class="text-danger">* 표시가 되어 있는 부분은 필수 항목입니다.</p>
                     ...
                     <form name="registerForm" action="memeditok.jsp" id="registerform" class="registerform" method="post">
                    <div class="row">
                        <div class="col-5 d-flex align-items-center mb-4">
                            <label for="username" class="text-right mr-3 col-4">이름*</label>
                            <input type="text" name="username" id="username" 
                                   class="form-control col-8" placeholder="이름" value="<%=username%>"/>
                        </div>
                        <div class="col-5 d-flex align-items-center mb-4">
                            <label for="uid" class="text-right mr-3 col-4">아이디*</label>
                            <input type="text" name="userid" id="userid" 
                                   class="form-control col-8" placeholder="아이디" value="<%=userid%>" />
                        </div>
                        ...
                        <div class="col-5 d-flex align-items-center mb-4">
                            ...
                            <input type="password" name="userpass" id="userpass"
                                   class="form-control col-8" placeholder="비밀번호" value="<%=userpass%>">
                        </div>
                        <div class="col-5 d-flex align-items-center mb-4">
                            <label for="repassword" class="text-right mr-3 col-4">비밀번호 확인</label>
                            <input type="password" name="reuserpass" id="reuserpass"
                                   class="form-control col-8" placeholder="비밀번호확인" value="<%=userpass%>">
                        </div>
                        <div class="col-2 mb-4"></div>
                        ...
                        <div class="col-6 d-flex align-items-center mb-4">
                            ...
                            <input type="text" name="useremail" id="useremail"
                                   class="form-control col-8" placeholder="이메일"  value="<%=useremail%>">
                        </div>
                        ...
                        <div class="col-8 d-flex align-items-center mb-4">
                          ...
                          <input type="text" name="usertel" id="usertel"
                           ...
                           oninput="autoHyphen(this)" maxlength="13" value="<%=usertel%>"> 
                        </div>
                        <div class="col-4"></div>
                        ...
                        <div class="col-12 d-flex">
                            ...
                            <input type="text" name="addr1" id="addr1"
                                 class="form-control col-7 mx-2 mt-1" placeholder="주소" value="<%=addr1%>" readonly>
                        </div>
                        <div class="col-12 d-flex mb-4">
                          <label for="zip" class="text-right mr-2 col-5 bg-white"></label>
                          <input type="text" name="addr2" id="addr2"
                               class="form-control col-7 mx-2 mt-1" placeholder="상세주소" value="<%=addr2%>">
                        </div>
                        <div class="col-12 d-flex mb-4">
